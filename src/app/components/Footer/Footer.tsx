...
const colunas = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Casas de apoio", to: "/projetos" },
      { label: "Escola Viva", to: "/projetos" },
      { label: "Projeto Adolescente Aprendiz", to: "/projetos" },
      { label: "Ações de Rua e Ronda Noturna", to: "/projetos" },
      { label: "Apoio a idosos jovens e população LGBTQIA+", to: "/projetos" },
    ],
  },
  {
    titulo: "Causas",
    links: [
      { label: "HIV/AIDS e direitos humanos", to: "/causas" },
      { label: "Inclusão social e combate ao preconceito", to: "/causas" },
      { label: "Segurança alimentar", to: "/causas" },
      { label: "Defesa das minorias políticas", to: "/causas" },
    ],
  },
  {
    titulo: "Apoie",
    links: [
      ...
      { label: "Seja um doador mensal", to: "/transparencia" },
      { label: "Destine seu Imposto de Renda", to: "/transparencia" },
      { label: "Seja um parceiro", to: "/transparencia" },
      { label: "Voluntariado", to: "/transparencia" },
    ],
  },
];
...
export function Footer() {
  ...
  const email = "ibcm33@terra.com.br";
  const telefone = "(71) 3450-9759";
  const cnpj = "CNPJ 00.584.568/0001-05";
  const instagramUrl = "https://www.instagram.com/instituicaoibcm/";
  const facebookUrl = "https://www.facebook.com/instituicaoibcm";
