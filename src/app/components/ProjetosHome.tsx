...
const STATIC_PROJETOS = [
  ...
  },
  {
    ...
    tagColor: "var(--musgo)",
    gradient:
      "linear-gradient(90deg, var(--musgo) 0%, var(--musgo-light) 100%)",
    descricao:
...
function ProjetoCard({ projeto, index }: { projeto: CardData; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ height: "3px", background: projeto.gradient, flexShrink: 0 }}
      />
  ...
  return (
    <section
      style={{
        ...
        padding: "clamp(48px, 7vw, 104px) clamp(16px, 5vw, 60px)",
      }}
    >
      <div
      ...
      >
        <div>
          ...
          <p style={{ color: "#1C1917", opacity: .7 }}>
