...
export function CausasPage() {
  ...
  const causas = wpCausas?.filter((c) => c.acf.ativo).map(wpToCausa) ?? STATIC_CAUSAS
  ...
  return (
    <>
      <PageBanner
        ...
        lead="São as causas que nasceram junto com o IBCM e que continuam guiando cada ação: acolhimento de pessoas vivendo com HIV/AIDS, moradia digna e defesa dos direitos de quem mais precisa."
