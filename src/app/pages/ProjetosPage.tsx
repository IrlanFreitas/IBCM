...
const STATIC_PROJETOS: Projeto[] = [
  ...
  },
  {
    ...
    cor: "var(--ocre)",
    image:
      "https://images.unsplash.com/photo-1573152143286-0c422b4d2175?w=1200&auto=format&fit=crop&q=80",
    descricao:
...
export function ProjetosPage() {
  ...
  const projetos =
    wpProjetos?.filter((p) => p.acf.ativo).map(wpToProjeto) ?? STATIC_PROJETOS;
  ...
  return (
    <>
      <PageBanner
        ...
        lead={
          <>
            Da primeira infância à terceira idade, a IBCM desenvolve projetos de
            educação, moradia, saúde, trabalho, convivência e defesa de
            direitos. <br />
            <br />
            Cada frente responde a uma necessidade concreta. Juntas, elas
            sustentam a mesma missão: cuidar de vidas e garantir que ninguém
            seja deixado para trás.
            <br />
            <br />
            <strong>Conheça os projetos</strong>
          </>
        }
